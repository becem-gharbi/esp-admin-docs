...
The application is built on top of Nuxt 3. It's a modern web framework that makes building full-stack apps super easy.
...
Nuxt comes with a server engine called **Nitro**. Protability is one of it's features that can make the server-side code runs on Node.js server, serverless and edge workers.
...
Nuxt is built on top of **Vue 3** which is a frontend JS framework popular for it's reactivity system and composable logic.
